  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="fixed right-4 bottom-4 sm:right-6 sm:bottom-6 w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center hover:bg-[#20BA5A] transition-all duration-300 touch-manipulation"
        style={{ zIndex: 9999 }}
